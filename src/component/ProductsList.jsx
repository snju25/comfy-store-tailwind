  ...
  return (
    <div className="mt-12 grid gap-y-8">
      {products.map((product)=>{
        ...
        const {id} = product
        return <Link to= {`/products/${id}`} key={id} className="p-8 rounded flex flex-col sm:flex-row gap-y-4 flex-wrap bg-base-100 shadow-xl hover:shadow-2xl duration-300 group">
